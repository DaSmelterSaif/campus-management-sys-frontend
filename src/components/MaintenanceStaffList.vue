<template>
    <div class="p-8">
        <div>
            <h1 class="text-5xl font-semibold mb-12">Maintenance Requests</h1>
            ...
            <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div v-for="request in maintenanceRequests" :key="request.requestId"
                    ...
                    <div class="mb-4">
                        <p class="text-sm text-gray-500 uppercase font-semibold">Ticket ID</p>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-sm text-gray-700">{{ request.category || 'N/A' }}</p>
                    </div>

                    <div class="mb-4">
                        <p class="text-sm text-gray-500 uppercase font-semibold">Location</p>
                        <p class="text-sm text-gray-700">{{ request.location || 'N/A' }}</p>
                    </div>
...
export default {
    ...
    methods: {
        async fetchMaintenanceRequests() {
            ...
            this.error = null;
            try {
                const response = await fetch(`${this.$API_BASE_URL}/getallmaintenance`);
